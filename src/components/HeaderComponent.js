...
import { Navbar, NavbarBrand, Jumbotron, Nav, NavbarToggler, Form, FormGroup, Input, Label, NavItem, Collapse, Modal, Button, ModalHeader, ModalBody } from 'reactstrap';
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody >
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup>
                                <Label htmlFor="usernpasswordame">Password</Label>
